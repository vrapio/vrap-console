<template xmlns:v-on="http://www.w3.org/1999/xhtml">
    <div>
        <div v-if="typeDeclaration.type.values" class="input-group col-sm-2">
            <select @change="updateValue" v-model="value" class="form-control">
...
<script src="./TypeInput.js"></script>
